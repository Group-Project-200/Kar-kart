...
map_image = pygame.image.load(os.path.join(BASE_DIR, "resources", "maps", Map_Name, "0.png"))
...
while running:
    ...
    label = font.render(f"MODE: {mode if mode else '(press C or S)'}", True, (255, 255, 255))
